...
# HOSTS & CORS
# ============================================================
ALLOWED_HOSTS = config("ALLOWED_HOSTS", default="reva.imrtechsolutions.com,localhost,127.0.0.1", cast=Csv())

CORS_ALLOWED_ORIGINS = config(
    "CORS_ALLOWED_ORIGINS",
    default="https://reva.imrtechsolutions.com,http://localhost:5173",
    cast=Csv(),
)
