...
from .views import (
    ...
    UpdatePOSOrderView, POSOrderDetailView, CancelPOSOrderView, DeletePOSOrderView, AddShopPOSOrderView
)
...
urlpatterns = [
    ...
    path("delete-pos-order/<int:pk>/", DeletePOSOrderView.as_view(), name="delete-pos-order"),
