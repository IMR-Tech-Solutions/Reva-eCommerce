...
import { getadminbrokercommissionreport } from "../../services/reportservices";
import { handleError } from "../../utils/handleError";
import {
  BrokerCommissionReportResponse,
  BrokerCommissionReportFilters,
} from "../../types/types2";
import { getallbrokerservice } from "../../services/brokerservices";

const AdminBrokerReport = () => {
  ...
  useEffect(() => {
    const fetchBrokers = async () => {
      try {
        const response = await getallbrokerservice();
        setAvailableBrokers(
          response.map((broker) => ({
            id: broker.id,
  ...
  const fetchReportData = async () => {
    ...
    try {
      ...
      const response = await getadminbrokercommissionreport(filters);
...
export default AdminBrokerReport;
