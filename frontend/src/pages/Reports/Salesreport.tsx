...
import { SalesReportResponse, ReportFilters } from "../../types/types";
...
const Salesreport = () => {
  ...
  const salesOptions: ApexOptions = {
    ...
    yaxis: {
      ...
      labels: {
        ...
        formatter: (value) => formatINRShort(value),
      },
    },
    grid: {
      yaxis: {
  ...
  return (
    <div>
      <PageMeta
        title="Sales Report"
        description="View detailed sales reports, track revenue, and analyze business performance."
      />
            ...
            <div className="min-w-[500px] xl:min-w-full">
              ...
              {isLoading ? (
                ...
                <Chart
                  ...
                  type="bar"
                  height={310}
                  key={`sales-${selectedPeriod}-${startDate}-${endDate}`}
                />
              )}
            </div>
          </div>
            ...
            <div className="min-w-[500px] xl:min-w-full">
              ...
              {isLoading ? (
                ...
                <Chart
                  ...
                  type="bar"
                  height={310}
                  key={`orders-${selectedPeriod}-${startDate}-${endDate}`}
                />
              )}
            </div>
          </div>
