// pages/reports/InventoryReport.tsx
...
import { getinventoryreport } from "../../services/reportservices";
...
const InventoryReport = () => {
  ...
  useEffect(() => {
    fetchInventoryData();
  }, [selectedPeriod, selectedStatus, startDate, endDate]);
  ...
  return (
    <div>
      <PageMeta
        ...
        description="View detailed inventory reports, track stock levels, and analyze batch performance."
      />
        ...
        <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
          <div className="w-full">
            ...
            <p className="mt-1 text-gray-500 text-theme-base dark:text-gray-400">
              {selectedPeriod === "day" && "Daily inventory analysis"}
              {selectedPeriod === "month" && "Monthly inventory analysis"}
              {selectedPeriod === "year" && "Annual inventory trends"}
            </p>
            ...
            <div className="min-w-[500px] xl:min-w-full">
              ...
              {isLoading ? (
                ...
                <Chart
                  ...
                  type="bar"
                  height={310}
                  key={`batches-${selectedPeriod}-${selectedStatus}-${startDate}-${endDate}`}
                />
              )}
            </div>
          </div>
            ...
            <div className="min-w-[500px] xl:min-w-full">
              ...
              {isLoading ? (
                ...
                <Chart
                  ...
                  type="bar"
                  height={310}
                  key={`stock-${selectedPeriod}-${selectedStatus}-${startDate}-${endDate}`}
                />
              )}
            </div>
          </div>
